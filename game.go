...
func loadTextures(eng sprite.Engine) []sprite.SubTex {
	...
	return []sprite.SubTex{
		texGopherRun1:  {t, image.Rect(n*0, 0, n*1, n)},
		texGopherRun2:  {t, image.Rect(n*1, 0, n*2, n)},
		texGopherFlap1: {t, image.Rect(n*2, 0, n*3, n)},
		texGopherFlap2: {t, image.Rect(n*3, 0, n*4, n)},
		texGopherDead1: {t, image.Rect(n*4, 0, n*5, n)},
		texGopherDead2: {t, image.Rect(n*5, 0, n*6-1, n)},
		texGround1:     {t, image.Rect(n*6+1, 0, n*7-1, n)},
		texGround2:     {t, image.Rect(n*7+1, 0, n*8-1, n)},
		texGround3:     {t, image.Rect(n*8+1, 0, n*9-1, n)},
		texGround4:     {t, image.Rect(n*9+1, 0, n*10-1, n)},
		texEarth:       {t, image.Rect(n*10+1, 0, n*11-1, n)},
	}
}
